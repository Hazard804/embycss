...
class HomeSwiper {
	static start() {
		...
		this.customCss = `
			/* 分页器过渡 */
			div.swiper-pagination-bullet { transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1); }
			...
			div.swiper-button-next:active, div.swiper-button-prev:active {
			...
			div.swiper-button-next:hover:after { transform: translateX(3px); }
			div.swiper-button-prev:hover:after { transform: translateX(-3px); }
			
			.mySwiper-main:hover .swiper-button-next, .mySwiper-main:hover .swiper-button-prev { opacity: 1; }
			
			/* 修正图片位置 */
			img.homevideos { object-position: center !important; } 
			...
			.homevideos .swiper-horizontal > .swiper-pagination-bullets .swiper-pagination-bullet, .homevideos .swiper-pagination-horizontal.swiper-pagination-bullets .swiper-pagination-bullet { 
				margin: var(--swiper-pagination-bullet-vertical-gap, 6px) 0; 
				display: block; 
			} 
			
			.cardLibText { position: absolute; bottom: 0.5em; left: 0.5em; font-weight: bolder; font-size: clamp(1rem, 0.2rem + 1vw, 1.2rem); color: #ffffff; border-radius: 0; pointer-events: none; } 
			.cardLibText button { border-radius: 0; } 
			.my-button-disabled, .my-button-hidden { opacity: 0 !important; } 
			
			.swiper-slide.swiper-null.swiper-slide-active { text-align: center; justify-content: center; display: flex; align-items: center; font-size: 3em; } 
			div.swiper-slide { overflow: hidden; } 
			.banner-cover { display: -webkit-box; display: -ms-flexbox; display: -webkit-flex; display: flex; -webkit-box-pack: center; -ms-flex-pack: center; -webkit-justify-content: center; justify-content: center; -webkit-box-align: center; -ms-flex-align: center; -webkit-align-items: center; align-items: center; } 
			
			div.swiper { width: 100%; height: 100%; margin-left: auto; margin-right: auto; position: absolute; right: 0; bottom: 0; --swiper-theme-color: #ff6600; --swiper-pagination-color: #00ff33 !important; --swiper-pagination-bottom: 0; --swiper-navigation-sides-offset: 30px; --swiper-pagination-bullet-border-radius: 10px; --swiper-pagination-bullet-inactive-color: #ffffff; --swiper-pagination-bullet-inactive-opacity: 1; --swiper-pagination-bullet-opacity: 1; --swiper-pagination-bullet-width: 5px; --swiper-pagination-bullet-height: 14px; --swiper-navigation-size: 20px; --swiper-pagination-bullet-vertical-gap: 3px; } 
			div.swiper-pagination-bullet-active { height: 24px; box-shadow: 0px 0px 20px rgba(252, 56, 56, 0.3); } 
			div.swiper-pagination-bullets.swiper-pagination-horizontal { left: calc(3.4vw + min(0.72em, max(0.48em, 1.78vw))) !important; text-align: left; } 
			
			.mySwiper .swiper-slide { transition: all 0.3s cubic-bezier(0, 1.75, 0.25, 1) 0s; margin-top: 50px; bottom: 0; } 
			.mySwiper .swiper-slide:hover { transform: scale(1.05); bottom: 10px; } 
			.swiper-button-next.swiper-button-disabled, .swiper-button-prev.swiper-button-disabled { opacity: 0; } 
			
			.swiper-button-next.swiper-child-button, .swiper-button-prev.swiper-child-button { transform: rotate(90deg) scale(0.9); left: auto; right: 28px; } 
			.swiper-button-next.swiper-child-button:hover, .swiper-button-prev.swiper-child-button:hover { transform: rotate(90deg) scale(1); } 
			.swiper-button-next.swiper-child-button { top: 65%; } 
			.swiper-button-prev.swiper-child-button { top: 35%; } 
			
			.swiper-slide .custom { color: #fff; -webkit-box-sizing: border-box; box-sizing: border-box; padding-bottom: 40px; padding-left: calc(3.4vw + min(0.72em, max(0.48em, 1.78vw))); position: absolute; left: 0; bottom: 10px; } 
			.swiper-slide img { display: block; width: 100%; height: 100%; object-fit: cover; object-position: center; } 
			div.swiper-slide { background-size: cover; background-position: center; } 
			div.mySwiper-main { height: 100%; width: 100%; } 
			div.mySwiper { height: auto; box-sizing: border-box; padding-bottom: 10px; right: 3.4%; width: 62%; } 
			.mySwiper .swiper-slide { width: 25%; filter: brightness(0.6); } 
			.mySwiper-main .swiper-slide .banner-cover { object-position: top; -webkit-mask-image: linear-gradient(to top, transparent 0%, black 30%); mask-image: linear-gradient(to top, transparent 0%, black 30%); } 
			.mySwiper .swiper-slide-thumb-active { opacity: 1; bottom: 10px; transform: scale(1.05); filter: brightness(1); } 
			
			.swiper-slide .title { font-size: 70px; font-weight: 700; text-align: left; } 
			.swiper-slide .subtitle { font-size: 28px; font-weight: 500; text-align: left; } 
			.swiper-slide .text { font-size: 20px; max-width: 30vw; line-height: 1.3; text-align: left; } 
			@media (min-width: 2560px) { .swiper-slide .text { max-width: 26vw; } div.mySwiper { width: 66%; } } 
			
			.custom > * { transition: all 1.5s cubic-bezier(0, 1.41, 0.36, 0.93) 0.4s; transform: translateY(150%); opacity: 0 !important; } 
			.swiper-slide-active .swiper-slide-active > .custom > * { transform: translateY(0); opacity: 1 !important; } 
			.custom > div:nth-child(1) { transition-delay: 1s; } 
			.custom > div:nth-child(2) { transition-delay: 1.2s; } 
			.custom > div:nth-child(3) { transition-delay: 1.4s; } 
			.custom > div:nth-child(4) { transition-delay: 1.6s; } 
			
			.custom .title { color: #fff !important; font-size: clamp(2rem, -0.362rem + 6.75vw, 4.7rem); font-weight: bolder; margin: 0; text-shadow: 0 4px 10px rgb(0 0 0 / 20%); max-width: 50vw; display: -webkit-box !important; -webkit-box-orient: vertical; -webkit-line-clamp: 1; overflow: hidden; } 
			.custom .subtitle { font-size: clamp(1rem, 0.5rem + 1vw, 1.7rem); font-weight: bold; text-align: left; } 
			.custom p { color: #fff !important; font-size: clamp(1rem, 0.4rem + 1vw, 1.6rem); font-weight: bold; opacity: 0.7; display: -webkit-box !important; -webkit-box-orient: vertical; -webkit-line-clamp: 4; overflow: hidden; } 
			.swiper-slide .morebutton { text-align: left; } 
			
			.autoplay-progress { position: absolute; left: 6px; bottom: 6px; z-index: 10; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; font-weight: bold; color: var(--swiper-theme-color); } 
			...
			.custom button::after {
				...
				transform: skewX(-25deg); transition: 0s; z-index: -1; pointer-events: none;
			}
			.custom button:hover::after { left: 100%; transition: 0.5s ease-in-out; }

			.banner-mask { position: absolute; width: 100%; height: 100%; top: 0; background-image: linear-gradient(90deg, rgba(0, 0, 0, 0.6), transparent); -webkit-mask-image: linear-gradient(to top, transparent 0%, black 10%); mask-image: linear-gradient(to top, transparent 0%, black 10%); pointer-events: none; } 
			.banner-logo { position: absolute; user-select: none; object-fit: contain !important; transform: translateY(clamp(-2rem, -3.455rem + 7.27vw, 2rem)); right: 0; opacity: 0; transition: 1s; transition-delay: 0.8s; width: 15% !important; height: 100px !important; bottom: min(7vw, 150px); } 
			.swiper-slide-active .banner-logo { transform: translateY(clamp(-2rem, -3.455rem + 7.27vw, 2rem)); opacity: 1; } 
			
			@media not all and (min-width: 50em) { .section00 { height: min(80vh, 148.5vw) !important; } .misty-loading h1 { font-size: 2em !important; } .mySwiper .swiper-slide:not(.swiper-slide-thumb-active), .mySwiper .cardContent-shadow, .mySwiper .cardContent-background { opacity: 0; } .mySwiper .swiper-slide { box-shadow: none; } div.mySwiper { right: -30% !important; width: 60% !important; } .custom button { border-radius: 6px !important; } .swiper-button-next, .swiper-button-prev { display: none; } .swiper-slide .title { max-width: 60vw !important; } .swiper-slide .subtitle { max-width: 60vw !important; } .swiper-slide .text { max-width: 50vw !important; } .autoplay-progress { display: none; } img.banner-logo { width: 30% !important; height: 50px !important; } .custom p { -webkit-line-clamp: 2 !important; } } 
			@media (pointer: fine) { ::-webkit-scrollbar { width: 0.3em !important; } div.overflowYScroll { scrollbar-width: auto; scrollbar-color: auto; } } 
			.skinHeader-withBackground { right: 0 !important; background-image: linear-gradient(rgba(0, 0, 0, 0.6), transparent); background-color: unset; } 
			.skinHeader-withBackground.headroom-scrolling { background-image: linear-gradient(black, transparent) !important; background-color: unset !important; } :is(.theme-appletv:root, .theme-light:root) .skinHeader-withBackground { background-image: linear-gradient( rgba(255, 255, 255, 0.6), transparent ) !important; } 
			.section00 { width: 100%; height: min(56.25vw, 100vh); position: relative; margin: 0; padding: 0; -webkit-mask-image: linear-gradient(to top, transparent 0%, black 6px); mask-image: linear-gradient(to top, transparent 0%, black 6px); } 
			.view[data-type="home"]:not(.home-horiz) > div:nth-child(1) .scrollSlider.padded-top-page, .view-home-home:not(.home-horiz) > div:nth-child(1) .scrollSlider.padded-top-page { padding-top: 0 !important; } 
			.view[data-type="home"]:not(.home-horiz) > div:nth-child(1) [is="emby-scroller"].flex, .view-home-home:not(.home-horiz) > div:nth-child(1) [is="emby-scroller"].flex { flex-wrap: nowrap; flex-direction: column; } 
			.misty-loading { z-index: 99999999; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 1); display: flex; align-items: center; justify-content: center; flex-direction: column; } 
			div.dialogContainer { z-index: 999999999 !important; } 
			.misty-loading h1 { margin: 0; margin-bottom: 3rem; text-transform: uppercase; transition: 0.8s; transform: scale(1.15); opacity: 0; font-size: 4em; } 
			.misty-loading h1.active { transform: scale(1); opacity: 1; } 
			.misty-loading .mdl-spinner { margin: 0; position: initial; } 
			.misty-loading .mdl-spinner__layer-1 { border-color: #fff; } 
			.mdl-spinner { zoom: 0.5; } 
			@keyframes spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}
			
			/* === 刷新按钮优化 === */
			button.swiper-refresh-btn{
				position:fixed;right:1rem;bottom:1rem;z-index:99999999;
				background:rgba(0,0,0,0.5);color:#fff;
				border:1px solid rgba(255,255,255,0.15);
				padding:0;width:48px;height:48px;border-radius:50%;cursor:pointer;
				box-shadow:0 6px 18px rgba(0,0,0,0.3);
				backdrop-filter:blur(12px);
				transition:all 0.5s cubic-bezier(0.68, -0.55, 0.265, 1.55);
				display:flex;align-items:center;justify-content:center;
			}
			button.swiper-refresh-btn svg{width:24px;height:24px;transition:transform .4s cubic-bezier(0.34, 1.56, 0.64, 1);}
			button.swiper-refresh-btn:hover{
				transform:translateY(-5px) scale(1.1);
				background:rgba(255,255,255,0.2);
				box-shadow:0 12px 28px rgba(0,0,0,0.5), 0 0 10px rgba(255,255,255,0.2);
			}
			button.swiper-refresh-btn:hover svg{transform:rotate(180deg) scale(1.1);}
			button.swiper-refresh-btn:active{transform:scale(0.9);transition:0.1s;}
			button.swiper-refresh-btn:disabled{opacity:0.5;pointer-events:none;}
			button.swiper-refresh-btn.spinning svg{animation:spin 1s linear infinite;}
			@media(max-width:720px){button.swiper-refresh-btn{right:0.6rem;bottom:0.6rem;width:42px;height:42px;}button.swiper-refresh-btn svg{width:20px;height:20px;}}
		`;
